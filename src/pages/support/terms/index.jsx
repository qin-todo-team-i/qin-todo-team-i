...
const Terms = () => {
  return (
    <div className="prose mx-auto">
      ...
      <h2>第１条 利用登録等</h2>
      <p>本サービスは、本サービスを利用する各ユーザーを識別するための文字列を設定することがあります。</p>
      <p>
      ...
      <ul>
        ...
        <li>
          本規約に違反したことがある者からの招待による利用登録である場合 第三者になりすますことを目的としている場合
        </li>
        <li>
          本サービスの判断により､新規の利用を制限している場合 前各号以外で、本サービスが不適切な利用であると判断する場合
        </li>
      </ul>

      <h2>第２条 登録情報</h2>
      <p>ユーザーは、登録情報について、自己の責任の下、登録及び管理するものとします。</p>
      <p>
      ...
      <h2>第４条 個人情報について</h2>
      <p>本サービスは、ユーザーから取得した個人情報の保護に最大限の注意を払います。</p>
      <p>
      ...
      <ul>
        ...
        <li>第三者の商品又はサービスに関する広告を提供するため アンケート、懸賞、キャンペーンの実施のため</li>
        <li>マーケティング調査、統計、分析のため 規約、条件、ポリシーの変更等の通知を連絡するため</li>
        <li>その他本サービスが運営する各サービスにおいて定める目的のため</li>
      </ul>
      <p>本サービスは、個人情報の取扱い業務の一部を他社に委託する場合があります。</p>
      <p>
      ...
      <p>本サービスは、個人情報を、個人情報保護管理者の統括の下、管理します。</p>
      <p>
      ...
      <p>その他、本サービスのプライバシーに対する考え方の詳細については、プライバシーポリシーを参照してください。</p>
      ...
      <h2>第６条 禁止行為</h2>
      <p>ユーザーは、以下の行為又はそのおそれがある行為を行ってはならないものとします。</p>
      <ul>
        ...
        <li>
          政治的活動、宗教活動、宗教団体への勧誘する行為 異性交際を求める/求めに応じる等の不適切な交際を促進する行為
        </li>
        <li>登録情報において、実在する第三者の人物・団体名などを登録する行為 他のユーザー又は第三者になりすまして</li>
        <li>本サービスを利用する行為 連鎖講（マルチ商法、ねずみ講、マルチまがい商法）などに類する勧誘・取引行為</li>
        <li>
          本サービス内の機能、本サービス内の機能の操作、その他本サービスに関する一切の事由について、現実の通貨で売買する行為
        </li>
        <li>
          本サービスのサーバー又はネットワークに悪意をもって負荷をかける行為 チートツール、BOT、その他の技術を利用して
        </li>
        <li>本サービスを不正に操作する行為 本サービスに発生した不具合を意図的に利用する行為</li>
        <li>ジェイルブレイク等、端末に対して改変を行った状態での 本サービスへのアクセス行為</li>
        <li>
          本サービスの全部又は一部を複製もしくは改変する行為、又は逆コンパイル等のリバースエンジニアリングをする行為
        </li>
        <li>本サービスを第三者に再配布する行為 本サービスに関するウェブサイト上の情報を改ざん、又は消去する行為</li>
        <li>他のユーザー又は第三者をコンピューター・ウイルスに感染させる行為 その他</li>
        <li>本サービスにて本サービスが不正と判断する行為 その他本サービスが不適切と判断する行為</li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>ユーザーが反社会勢力に該当しもしくは該当していたことが判明した場合 本サービスの保守のために必要な場合</li>
        <li>本サービスのシステムに不具合があった場合 その他本規約に違反する行為があった場合</li>
      </ul>
      <p>本サービスはユーザーに対して、前項の措置を講じた理由を開示する義務を負わないものとします。</p>
      <p>
...
const title = "利用規約";
Terms.getLayout = (page) => AccountLayout(page, title);
